...
사실 jenkins 등을 설치할 때, 가장 깔끔한 방법은 helm chart를 다운로드 받아서 
초기값을 최대한 자신이 원하는 바로 수정하여 패키징한 후 설치하는 것입니다.
이렇게 설치하면 삭제 후 재설치나 다른 클러스터에 설치하는 등의 응용 시 편리해집니다.

여기서는 학습의 의도로 구성했기에 한 단계씩 안되는 것을 확인하고 이를 수습해 가면서 전진하는 방법을 택했습니다.
하지만 여러분은 이걸 잘 익혀서 최선의 방법을 찾으시길 바랍니다.
